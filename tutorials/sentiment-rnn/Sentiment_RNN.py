...
vocab_to_int = {key: value for value, key in enumerate(vocab_list, 1)}
...
# the features are already zeros, next step is to slice 200 to fill it.
...
val_x, val_y = features[split_idx:], labels[split_idx:]

test_idx = int(len(val_x)*0.5)
val_x, val_y = val_x[test_idx:], val_y[test_idx:]
test_x, test_y = val_x[:test_idx], val_y[:test_idx]
...
# # Tunning
# |lstm size| lstm layers | batch size| learning_rate|epoch|accuracy|loss|reason|
# |---|
# |256|1|500|0.001|10|0.500|None|high bias|
# |256|2|500|0.001|10|0.500|None|high bias|
# |512|2|512|0.001|10|0.487|0.080|high bias|
# |512|3|1024|0.0001|10|0.513|0.078|high bias|
# |512|1|512|0.001|10|0.512|0.051|high bias|
# |512|2|512|0.001|10|0.793|0.138|
